...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanGetSummaryViewModel()
        {
            ...
            products.Insert(new Product { Id = "2", Price = 9.00m });
            ...
            Assert.AreEqual(29.00m, basketSummary.BasketTotal);
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "bl3kitny@gmail.com", ZipCode = "11130" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("bl3kitny@gmail.com", "Forms"), null);
